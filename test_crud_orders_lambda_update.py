...
AUTH_TOKEN = "eyJraWQiOiJFd0xhRE45MDBYeWVyNjBxQlU4U3g3Mk9TcFVBeWd2OUx2NkpGUHRHaUljPSIsImFsZyI6IlJTMjU2In0..gPyW9O8iueA8qb8WsWi6uOyRaXaCLjUeI2Dd9SvDf8ZB6ws8d4gYKUENZHuBU2TyCldie4DP_f3dzH4DbcpLPBIxv-c_dLmfqt2EBCmSG6DpgBqvci4Fzac4kMQysWij5y6J_8Q4aD4uzqyhzxJS3nISnvTbe44MwExnYoeCl8hieShNg0JRNdN5_lgyN9HH2iRmUhhTpQ2VA7cYYlTrpcG-GoMtWrD5Kt1sKd3A47ketelP_15DSqyhCrUXvXnugHJ9iBmhuBHwG8qLZKKUDEiLS9DpcwyOKtSl2_DD-LkV4FbntFVds9qQ5pXXjxjYQhKZysX8o5gX7axeNcLWTQ"
HEADERS = {
...
def test_lambda_function_execution(payload):
    ...
    for log in logs:
        print(f"LOGS: {log}")
        if "Update operation completed successfully" in log['message']:
